...
const { signup, login, uploadImage } = require("./route_handlers/users"); // Import route handlers
const { createEvent } = require("./route_handlers/events");
...
app.post("/event/create", auth, checkAdmin, createEvent);
